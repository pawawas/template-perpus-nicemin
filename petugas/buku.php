        ...
        <div class="card-body">
            ...
            <table class="table table-bordered border-primary">
                ...
                <tbody>
                    ...
                    $result = mysqli_query($koneksi, "SELECT id_buku, nama_kategori,judul,penulis,penerbit FROM buku INNER JOIN kategori_buku on buku.id_kategori = kategori_buku.id_kategori");
