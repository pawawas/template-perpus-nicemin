...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE buku SET id_kategori = '$kategori', judul = '$judul', penulis = '$penulis', penerbit = '$penerbit' WHERE id_buku = '$id'";
...
<body>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- Vertical Form -->
            <?php
            $sql = mysqli_query($koneksi, "SELECT id_buku, nama_kategori,judul,penulis,penerbit FROM buku INNER JOIN kategori_buku ON buku.id_kategori=kategori_buku.id_kategori WHERE id_buku ='$id'");
